...
class Assertions(unittest.TestCase):
    ...
    #     file_path=os.path.abspath("E:\\workspace\\selenium\\python-selenium2\\html\\objects.html")
    ...
    # def testFrame(self):
    #     driver=self.driver
    #     file=os.path.abspath("E:\\workspace\\selenium\\python-selenium2\\html\\frame.html")
    #     driver.get(file)
